...
//     version 1.17.0
//     from Assets/Inputs/Camera_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/Camera_Actions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Camera_Actions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Camera"",
            ""id"": ""c304e516-99d1-43be-ab95-4992e59c70d4"",
            ""actions"": [
                {
                    ""name"": ""MouseScrollY"",
                    ""type"": ""PassThrough"",
                    ""id"": ""26559722-c8fd-4927-8721-f0fa91158e9f"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""011820c0-65ca-45af-abb0-dca8ea52224a"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@Camera_Actions()
    {
        UnityEngine.Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, Camera_Actions.Camera.Disable() has not been called.");
    }
    ...
    {
        private @Camera_Actions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public CameraActions(@Camera_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Camera/MouseScrollY".
        /// </summary>
